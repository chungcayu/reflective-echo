...
火山引擎 API
"""
hs_app_id = os.getenv("HUOSHAN_APP_ID")
hs_access_token = os.getenv("HUOSHAN_ACCESS_TOKEN")
hs_cluster_id = os.getenv("HUOSHAN_TTS_CLUSTER_ID")

# 选择音色：灿灿 2.0：BV700_V2_streaming ｜ 超自然音色-梓梓  BV406_streaming | 超自然音色-梓梓2.0：BV406_V2_streaming ｜ 超自然音色-燃燃2.0：BV407_V2_streaming
hs_voice_type = "BV406_streaming"  # 超自然音色-梓梓
...
讯飞 API
"""
xf_app_id = os.getenv("XUNFEI_APP_ID")
xf_api_key = os.getenv("XUNFEI_API_KEY")
